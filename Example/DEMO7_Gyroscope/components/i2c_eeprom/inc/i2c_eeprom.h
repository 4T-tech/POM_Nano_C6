 ...
 */
int32_t i2c_eeprom_write(void *eeprom_handle, uint8_t address, const uint8_t *data, uint16_t size);
 ...
 */
int32_t i2c_eeprom_read(void *eeprom_handle, uint8_t address, uint8_t *data, uint16_t size);
